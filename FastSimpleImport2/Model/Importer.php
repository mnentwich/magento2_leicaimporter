...
class Importer
{
    ...
    {
        if ($this->importModel->getEntity() == "category") {
    ...
    protected function _importCategoryData()
    {
        ...
        $repo = new \Magento\Catalog\Model\CategoryRepository();

        $newcat = new \Magento\Catalog\Model\Category;
        $newcat->setName("TEST 123");
        $newcat->setUrlKey("test-category");
        $newcat->setIsActive(0);
